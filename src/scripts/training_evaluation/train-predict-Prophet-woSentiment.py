...
# python src/scripts/training_evaluation/train-predict-Prophet-woSentiment.py Prophet Prophet_woSentiment datasets/processed_data/feature_importance/LightGBM/ datasets/processed_data/model_predictions/Prophet/woSentiment/ trained_models/Prophet/
